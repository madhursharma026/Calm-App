...
import { Platform, SafeAreaView, StatusBar, Text, Image, ScrollView, ImageBackground, View, StyleSheet } from "react-native";
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "black" }}>
      ...
      <ScrollView style={{ marginBottom: 60 }}>
        <LinearGradient style={{ flex: 1 }} start={{ x: 0, y: 1 }} end={{ x: 0, y: 0 }} colors={Platform.OS == "web" ? ["black", "black"] : ["#3a88d6", "#28266e"]}>
          <ImageBackground source={{ uri: 'https://pbs.twimg.com/media/D0a8ebuX0AAMuNJ?format=jpg&name=4096x4096' }} style={{ width: '100%', height: 300 }}>
            <View style={{ alignItems: 'center', marginTop: 15 }}>
              <Image source={{ uri: `https://branditechture.agency/brand-logos/wp-content/uploads/wpdm-cache/Calm-900x0.png` }} style={{ width: 120, height: 100 }} />
            </View>
          </ImageBackground>
          <View style={{ marginTop: 15 }}>
            <Text style={{ fontSize: 17, color: 'white', marginLeft: 15 }}>Good Morning</Text>
          ...
          <View style={{ marginTop: 5 }}>
            ...
            <Text style={{ fontSize: 16, color: 'white', marginLeft: 22, marginBottom: 10 }}>Recommended Collections</Text>
            <Text style={{ fontSize: 16, color: 'white', marginRight: 22, marginTop: -30, marginBottom: 10, textAlign: 'right' }}>See all</Text>
            <RecommendedCards list={RecommendedCardsDetails} style={{ marginLeft: -30 }} />

            <View style={styles.hr} />

            <Text style={{ fontSize: 16, color: 'white', marginLeft: 22, marginBottom: 10 }}>Quick & Easy</Text>
            <Text style={{ fontSize: 16, color: 'white', marginRight: 22, marginTop: -30, marginBottom: 10, textAlign: 'right' }}>See all</Text>
            ...
            <Text style={{ fontSize: 16, color: 'white', marginLeft: 22, marginBottom: 10 }}>Mental Fitness</Text>
            <Text style={{ fontSize: 16, color: 'white', marginRight: 22, marginTop: -30, marginBottom: 10, textAlign: 'right' }}>See all</Text>
            <MoreCards list={RecommendedCardsDetails} style={{ marginLeft: -30 }} />
            ...
            <Text style={{ fontSize: 16, color: 'white', marginLeft: 22, marginBottom: 10 }}>Sleep Stories</Text>
            <Text style={{ fontSize: 16, color: 'white', marginRight: 22, marginTop: -30, marginBottom: 10, textAlign: 'right' }}>See all</Text>
            <MoreCards list={RecommendedCardsDetails} style={{ marginLeft: -30 }} />
      ...
      <BottomNav navigation={navigation} onScreen="HomeScreen" />
    </SafeAreaView>
  );
};
